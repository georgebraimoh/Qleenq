      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-[#EFE8DB]">
          ...
          <div className="md:col-span-6 space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-xl bg-[#E2522B] flex items-center justify-center text-white font-heading font-bold">
                Q
              </div>
            ...
            <div className="inline-flex items-center gap-2 text-xs font-semibold text-[#171717] bg-[#FFF7EC] px-3 py-1.5 rounded-full border border-[#EFE8DB]">
              <Globe className="w-3.5 h-3.5 text-[#E2522B]" />
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-[#6F6F6F]">
              <li>
                <Link to="/explore" className="hover:text-[#E2522B] transition-colors flex items-center gap-1.5">
                  <Compass className="w-3.5 h-3.5 text-[#E2522B]" />
                  <span>Explore Activities</span>
                </Link>
              </li>
              <li>
                <Link to="/create" className="hover:text-[#E2522B] transition-colors flex items-center gap-1.5">
                  <Plus className="w-3.5 h-3.5 text-[#E2522B]" />
                  <span>Host an Experience</span>
                </Link>
              </li>
              <li>
                <Link to="/safety" className="hover:text-[#E2522B] transition-colors flex items-center gap-1.5">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#6F6F6F]">
          ...
          <p className="flex items-center gap-1">
            Built with <Heart className="w-3.5 h-3.5 text-[#E2522B] fill-[#E2522B]" /> for real human connections everywhere.
          </p>
        </div>
      </div>
    </footer>
