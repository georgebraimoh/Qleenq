      ...
      <div className="flex items-center justify-around">
          ...
          {({ isActive }) => (
            <motion.div
              ...
              className={`flex flex-col items-center gap-1 text-xs font-medium transition-colors ${
                isActive ? 'text-[#800020]' : 'text-[#6F6F6F]'
              }`}
            >
              ...
              {isActive && (
                <motion.div
                  ...
                  className="w-1.5 h-1.5 rounded-full bg-[#800020] absolute -bottom-1"
        ...
        >
          <motion.div
            ...
            whileTap={{ scale: 0.92 }}
            className="w-12 h-12 rounded-full bg-[#800020] text-white flex items-center justify-center shadow-lg shadow-[#800020]/30 border-2 border-white"
          >
